import { FaCode, FaRegUser, FaBriefcase } from "react-icons/fa";
        ...
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                    <h3 className="text-2xl font-semibold">Passionate Web Developer & Graphic Designer</h3>
                    ...
                    <p className="text-muted-foregroound">
                        I'm passionate about creating elegant design to complex
                        problems, and I'm constantly learning new design, technologies
