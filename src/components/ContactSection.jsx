...
export const ContactSection = () => {
    ...
    className="py-24 px-4 relative bg-secondary/30">
        <div className="container mx-auto max-w-5xl">
            <h2 className="text-3xl md:texl-4xl font-bold mb-4 text-center">Get In
            ...
            <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                Have a project in mind or what to collaborate? Feel free to reach out.
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6 justify-center">
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+6289616364564" className="text-muted-foreground hover:text-primary transition-colors">
                                    +62 (896) 1636 4564
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="pt-8">
                        ...
                        <div className="flex space-x-4 justify-center">
                            <a href="https://www.linkedin.com/in/muhammad-januar-5401b2269/" target="_blank">
                                <Linkedin />
                            </a>
                    ...
                    <form action="" className="space-y-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                required
                                className="w-full px-4 py-3 rounded-md border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary"
                                placeholder="iqbls.jnr@gmail.com"
                            />
                        </div>
                        <div>
                            <label htmlFor="name" className="block text-sm font-medium mb-2">
